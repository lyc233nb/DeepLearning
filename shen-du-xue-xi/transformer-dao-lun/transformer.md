...
在自注意力模型（self-attention）中，给定一个输入序列，我们需要计算该序列中每个元素与其他元素的相关度，以此来推断其重要性。假设我们有一个输入序列 $$x_1, x_2, ..., x_n$$，那么它的自注意力表示为$$A \in \mathbb{R}^{n \times n}$$，其中 $$A_{i,j}$$ 表示 $$x_i$$ 和 $$x_j$$的相关度。
...
其中, $$e_{i,j}$$是一个表示 $$x_i$$ 和 $$x_j$$ 相关度的能量值。在使用自注意力时，通常会采用点积（dot-product）或加性（additive）的方式来计算 $$e_{i,j}$$。
...
<figure><img src="../../.gitbook/assets/17061.jpg" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/1706.jpg" alt=""><figcaption></figcaption></figure>
